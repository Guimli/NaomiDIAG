...
-- force D5 low over the top 64 KB of the 32 MB SDRAM: blocks 1..8 of the scan
notif = emu.add_machine_frame_notifier(function()
    for a = 0x0dff0000, 0x0dffff00, 0x40 do
        local v = mem:read_u32(a)
        if (v & 0x20) ~= 0 then mem:write_u32(a, v & ~0x20) end
    end
end)
print("[reloc_scan_fault] D5 force a 0 sur les 64 Ko de sommet")
